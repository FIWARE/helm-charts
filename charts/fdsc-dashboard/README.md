...
| autoscaling.apiVersion | string | `"v2beta2"` | apiVersion of the HorizontalPodAutoscaler resource emitted by the `fiwareCommon.hpa.tpl` helper. Users on Kubernetes 1.26+ may wish to override this to "v2". |
