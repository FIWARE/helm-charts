...
![Version: 0.16.19](https://img.shields.io/badge/Version-0.16.19-informational?style=flat-square) ![AppVersion: 1.10.2](https://img.shields.io/badge/AppVersion-1.10.2-informational?style=flat-square)
...
| defaultConfig.image.tag | string | `""` | overrides the image tag whose default is the chart appVersion |
