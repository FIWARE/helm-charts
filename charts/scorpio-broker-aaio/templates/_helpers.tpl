...
helm.sh/chart: {{ include "scorpioBroker-aaio.chart" . }}
{{ include "scorpioBroker-aaio.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "scorpioBroker-aaio.name" . }}
...
{{- default (include "scorpioBroker-aaio.fullname" .) .Values.serviceAccount.name }}
{{- else }}
