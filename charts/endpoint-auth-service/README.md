...
![Version: 0.0.14](https://img.shields.io/badge/Version-0.0.14-informational?style=flat-square) ![AppVersion: 0.4.3](https://img.shields.io/badge/AppVersion-0.4.3-informational?style=flat-square)
...
1. (Recommended) Hand it over to [cert-manager](https://cert-manager.io/docs/)
...
| configService.configmapUpdater.image.tag | string | `"0.4.3"` | tag of the image to be used |
...
| configService.image.tag | string | `"0.4.3"` | tag of the image to be used |
...
| configService.meshExtensionUpdater.image.tag | string | `"0.4.3"` | tag of the image to be used |
...
| ishare.image.tag | string | `"0.4.3"` | tag of the image to be used |
...
| sidecar.image.tag | string | `"0.4.3"` | tag of the image to be used |
...
| sidecar.initConfig.tag | string | `"0.4.3"` | tag of the image to be used |
...
| sidecar.initIptables.tag | string | `"0.4.3"` | tag of the image to be used |
...
| sidecar.updateConfig.tag | string | `"0.4.3"` | tag of the image to be used |
