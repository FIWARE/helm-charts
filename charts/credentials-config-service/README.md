...
![Version: 2.4.4](https://img.shields.io/badge/Version-2.4.4-informational?style=flat-square) ![AppVersion: 3.3.5](https://img.shields.io/badge/AppVersion-3.3.5-informational?style=flat-square)
...
| deployment.image.tag | string | `"3.3.5"` | tag of the image to be used. If empty, AppVersion is used |
...
| registration.enabled | bool | `false` | should automatic registration be enabled |
| registration.prepScript | string | `nil` | optional prepariation script |
